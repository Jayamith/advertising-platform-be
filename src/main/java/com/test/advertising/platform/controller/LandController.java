...
//	}
	@PutMapping(value = { "/lands/{id}" }, consumes = { MediaType.MULTIPART_FORM_DATA_VALUE })
	public Land updateLand(@PathVariable Integer id, @RequestPart("land") Land land, @RequestPart("imageFile") MultipartFile[] file) {
