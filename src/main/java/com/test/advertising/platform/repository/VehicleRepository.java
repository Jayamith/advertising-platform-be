...
public interface VehicleRepository extends JpaRepository<Vehicle, Integer>{
	...
	@Query("select v from Vehicle v where v.seller=:seller")
	public List<Vehicle> findAllBySeller(@Param("seller") String seller);
//	List<Vehicle> findVehiclesBySellerName(String seller);
