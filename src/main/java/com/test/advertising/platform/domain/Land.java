...
public class Land {
	...
	@JoinTable(name = "land_images", joinColumns = { @JoinColumn(name = "land_id") }, inverseJoinColumns = {
	...
	public Land(Integer landId, String lname, String moreInfo, String email, String contact, String location,
			String price, String lCondition, String seller, String lsize, boolean sStatus, Date addedDate,
			Set<ImageModel> landImages) {
		super();
		this.landId = landId;
		this.lname = lname;
	...
	public Set<ImageModel> getLandImages() {
		return landImages;
	}

	public void setLandImages(Set<ImageModel> landImages) {
		this.landImages = landImages;
	}
